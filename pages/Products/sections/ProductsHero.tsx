            ...
            <div className="container mx-auto px-6 sm:px-12 lg:px-24 relative z-10 text-center lg:text-left">
                <div className="max-w-4xl mx-auto lg:mx-0">
                    <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
                        ...
                        <h2 className="text-[10px] sm:text-[11px] font-black tracking-[0.5em] text-aureole-blue">PRODUCT CATALOG</h2>
                    </div>
                    <h1 className="text-4xl sm:text-7xl lg:text-[100px] font-[950] font-heading text-[#001529] tracking-tighter leading-[0.85] mb-6 sm:mb-8">
                        OUR <br /> <span className="text-aureole-cyan tracking-normal">COLLECTION.</span>
                    </h1>

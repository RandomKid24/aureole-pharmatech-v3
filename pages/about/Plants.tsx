...
import { Factory, MapPin, Gauge, Shield, Cpu, Zap, Microscope, Boxes } from 'lucide-react';
    ...
    return (
        <div className="pt-24 min-h-screen bg-white">
            ...
            <section className="py-24 lg:py-40 bg-slate-50 relative overflow-hidden">
                <div className="container mx-auto px-6 sm:px-8 lg:px-16 mb-24 relative z-10">
                ...
                <div className="container mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
                    <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                        {galleryImages.map((img, i) => (
                            <div key={i} className="relative group overflow-hidden break-inside-avoid shadow-xl shadow-slate-200 rounded-sm">
                                <img
                                    src={img}
                                ...
                                <div className="absolute inset-0 bg-aureole-slate/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                                    <div className="p-4 border border-white/20 backdrop-blur-sm">
                                        <span className="text-[10px] font-black text-white uppercase tracking-[0.3em]">FACILITY VIEW</span>
                                    </div>
                                </div>
                            </div>
                        ))}

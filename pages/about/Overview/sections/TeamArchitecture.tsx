...
const TeamArchitecture: React.FC = () => {
    ...
    return (
        <section className="relative bg-transparent group/team">
            ...
            <div
                className={`grid transition-[grid-template-rows] duration-1000 ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'
                    }`}
            >
                                    ...
                                    <button
                                        onClick={() => {
                                            ...
                                            if (gate) {
                                                ...
                                                const elementPosition = gate.getBoundingClientRect().top;

...
const ComplianceGrid: React.FC = () => {
    ...
    const zedDetails = {
        level: "Gold",
        scheme: "MSME Sustainable (ZED) Certification Scheme",
        certNo: "19032026_634363",
        file: "/compliance/Gold Certification By ZED.pdf"
    };
                ...
                <div className="grid lg:grid-cols-3 gap-px bg-transparent">
                    ...
                    <div className="bg-white p-10 lg:p-14 relative overflow-hidden group border-r border-slate-100">
                        ...
                        <div className="space-y-6 mb-12 relative z-10">
                            <div className="p-5 bg-slate-50 border-l-2 border-aureole-cyan rounded-r-sm flex items-center gap-6">
                                <span className="text-[9px] font-black text-slate-400 tracking-widest min-w-max">Directive</span>
                                <p className="text-sm font-black text-aureole-slate uppercase tracking-tighter">2007/47/EC (MDR)</p>
                            </div>
                        </div>

                        <a href={ceDetails.file} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-aureole-cyan text-[10px] font-black tracking-widest hover:text-aureole-blue transition-all group/link whitespace-nowrap">
                    ...
                    <div className="bg-white p-10 lg:p-14 relative overflow-hidden group border-r border-slate-100">
                        ...
                        <div className="space-y-6 mb-12 relative z-10">
                            <div className="p-5 bg-slate-50 border-l-2 border-aureole-blue rounded-r-sm flex items-center gap-6">
                                <span className="text-[9px] font-black text-slate-400 tracking-widest min-w-max">Registration No.</span>
                                <p className="text-sm font-black text-aureole-slate uppercase tracking-tighter">{isoDetails.id}</p>
                            </div>
                        </div>

                        <a href={isoDetails.file} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-aureole-blue text-[10px] font-black tracking-widest hover:text-aureole-cyan transition-all group/link whitespace-nowrap">
                    ...
                    <div className="bg-white p-10 lg:p-14 relative overflow-hidden group">
                        ...
                        <div className="space-y-6 mb-12 relative z-10">
                            <div className="p-5 bg-slate-50 border-l-2 border-aureole-blue rounded-r-sm flex items-center gap-6">
                                <span className="text-[9px] font-black text-slate-400 tracking-widest min-w-max">Certificate No.</span>
                                <p className="text-sm font-black text-aureole-slate uppercase tracking-tighter">{zedDetails.certNo}</p>
                            </div>
                        </div>

                        <a href={zedDetails.file} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-aureole-blue text-[10px] font-black tracking-widest hover:text-aureole-cyan transition-all group/link whitespace-nowrap">
                            <Download size={14} className="group-hover/link:-translate-y-1 transition-transform" /> View ZED Gold Certificate
                        </a>
                    </div>
                </div>
            </div>

                ...
                <div className="grid lg:grid-cols-[1fr_1.3fr] gap-12 lg:gap-20 items-center">
                    <div>
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h2 className="text-[11px] font-black tracking-[0.4em] text-aureole-blue">PRODUCT ENQUIRY</h2>
                        </div>
                                ...
                                <form className="space-y-8 relative z-10" onSubmit={handleSubmit} noValidate>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <div className={`flex items-center h-11 relative border-b-2 ${errors.fullName ? 'border-red-400' : 'border-slate-200'} transition-all group-focus-within:border-aureole-cyan`}>
                                                <input
                                                    ...
                                                    className="w-full bg-transparent py-2 text-[15px] font-bold text-[#001529] font-body placeholder:text-slate-300 placeholder:text-[10px] font-black tracking-widest focus:outline-none transition-all"
                                                />
                                            </div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-transparent border-b-2 border-slate-200 py-2 text-[15px] font-bold text-[#001529] font-body placeholder:text-slate-300 placeholder:text-[10px] font-black tracking-widest focus:outline-none focus:border-aureole-cyan transition-all resize-none"
                                        ></textarea>

            ...
            <div className="container mx-auto px-6 lg:px-16">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    {SERVICE_CENTERS.map((city, idx) => (
                        <div key={idx} className="bg-white border border-slate-100 p-6 hover:bg-white hover:border-aureole-cyan group transition-all duration-300 shadow-sm hover:shadow-md">

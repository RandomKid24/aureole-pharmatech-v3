            ...
            <div className="container mx-auto px-6 lg:px-16 relative z-10 text-center lg:text-left">
                <div className="max-w-5xl mx-auto lg:mx-0">
                    <div className="flex items-center justify-center lg:justify-start gap-4 mb-8">
                        ...
                        <h1 className="text-xs font-black uppercase tracking-widest text-aureole-blue">SUPPORT SERVICES</h1>
                    </div>

                    <h2 className="text-4xl lg:text-7xl font-black text-[#001529] uppercase tracking-tighter leading-none mb-12">
                        SUPPORT <br />

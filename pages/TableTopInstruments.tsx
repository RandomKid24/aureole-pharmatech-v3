        ...
        <div className="pt-24 min-h-screen bg-white">
            ...
            <section className="relative py-16 sm:py-32 overflow-hidden border-b border-slate-100 bg-white">
                <div className="absolute top-10 right-10 opacity-[0.02] pointer-events-none select-none">
                    <span className="text-[60px] md:text-[100px] lg:text-[150px] font-black text-[#001529] tracking-tighter leading-none uppercase">TABLE TOP</span>
                </div>
                ...
                <div className="container mx-auto px-6 sm:px-12 lg:px-24 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="text-4xl sm:text-7xl lg:text-[100px] font-[950] text-[#001529] uppercase tracking-tighter leading-[0.9] mb-8 sm:mb-12">
                            TABLE TOP <br /> <span className="text-aureole-cyan">INSTRUMENTS.</span>
                        </h1>
            ...
            <section className="py-16 sm:py-24 bg-white relative">
                <div className="container mx-auto px-6 lg:px-24">
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
                        ...
                        <div className="lg:col-span-4 space-y-3">
                            <div className="mb-12">
                                ...
                                <h2 className="text-4xl font-[950] text-[#001529] uppercase tracking-tighter leading-none">
                                    KEY <br /> <span className="text-aureole-cyan">DETAILS.</span>
                                </h2>
                            </div>
                        ...
                        {/* Content Column */}
                        <div className="lg:col-span-8 bg-slate-50/50 border border-slate-100 p-8 lg:p-16 relative overflow-hidden flex flex-col min-h-[300px]">
                            ...
                            <div className="relative z-10 grid sm:grid-cols-2 gap-x-12 gap-y-6">
                                {sections[activeSection].items.map((item, i) => (
                                    <div key={i} className="flex gap-4 group">
                                        ...
                                        <p className="text-[10px] font-bold text-[#001529] uppercase tracking-widest leading-relaxed opacity-70">
                                            {item}
                                        </p>
                                    </div>
                                ))}

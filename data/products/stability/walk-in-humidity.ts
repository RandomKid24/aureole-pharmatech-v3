...
export const walkInHumidityChamber: ProductDetail = {
    ...
    keyFeaturesHeading: "Key features of our walk-in humidity test chambers include",
    keyFeatures: [

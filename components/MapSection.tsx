              ...
              <form className="space-y-8">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="relative group">
                    ...
                    <input type="text" placeholder="FULL NAME" className="w-full bg-transparent border-b-2 border-slate-300 py-3 text-[11px] font-black uppercase tracking-widest text-[#001529] focus:outline-none focus:border-aureole-cyan transition-all" />
                  </div>
                  <div className="relative group">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Email</label>
                    <input type="email" placeholder="OFFICIAL EMAIL" className="w-full bg-transparent border-b-2 border-slate-300 py-3 text-[11px] font-black uppercase tracking-widest text-[#001529] focus:outline-none focus:border-aureole-cyan transition-all" />
                  </div>
                </div>

                <div className="relative">
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Product</label>
                  <select className="w-full bg-transparent border-b-2 border-slate-300 py-3 text-[11px] font-black uppercase tracking-widest text-[#001529] appearance-none focus:outline-none focus:border-aureole-cyan transition-all cursor-pointer">
                ...
                <div className="relative">
                  ...
                  <textarea rows={4} placeholder="DESCRIBE YOUR REQUIREMENTS..." className="w-full bg-transparent border-b-2 border-slate-300 py-3 text-[11px] font-black uppercase tracking-widest text-[#001529] focus:outline-none focus:border-aureole-cyan transition-all resize-none"></textarea>
                </div>

                <button className="flex items-center gap-8 group mt-8">
                  <div className="w-20 h-20 bg-aureole-blue rounded-full flex items-center justify-center text-white transition-all group-hover:scale-110 shadow-xl shadow-blue-500/20">
